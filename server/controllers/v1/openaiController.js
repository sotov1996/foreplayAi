...
const generateAnswer = async (req, res) => {
    try {
        ...
        const text = `You are dating expert. You help young men to pick-up girl (she told me about herself: ${message}) Generate Flirty pick-up text, from 30 to 45 characters. Please respond using the same language as used in the context data.`
